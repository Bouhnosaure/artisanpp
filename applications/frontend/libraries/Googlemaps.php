...
class Googlemaps {
	...
	function create_map()
	{
		...
		$this->output_html .= '<div id="'.$this->map_div_id.'" '.$this->map_div_id.' '.$this->map_data_theme.' '.$this->map_data_role.' style="width:'.$this->map_width.'; height:'.$this->map_height.';"'.(($this->class != "") ? ' class="'.$this->class.'"' : '').'></div>';
