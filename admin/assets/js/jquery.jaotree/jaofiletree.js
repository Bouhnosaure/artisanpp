...
(function( $ ) {
		...
		dataType: 'json',
                ...
                for(ij=0; ij<datas.length; ij++){
                    ...
                    if(options.usecheckboxes===true || (options.usecheckboxes==='dirs' && datas[ij].type=='dir') || (options.usecheckboxes==='files' && datas[ij].type=='file')){
                        ret += '<input type="checkbox" data-file="'+dir+datas[ij].file+'" data-ext="'+datas[ij].ext+'" data-type="'+datas[ij].type+'"/>';
                    }
                    else{
                        ret += '<input disabled="disabled" type="checkbox" data-ext="'+datas[ij].ext+'" data-file="'+dir+datas[ij].file+'" data-type="'+datas[ij].type+'"/>';
                    }
                    ret += '<a href="#" data-file="'+dir+datas[ij].file+'" data-ext="'+datas[ij].ext+'" data-type="'+datas[ij].type+'">'+datas[ij].file+'</a>';
                    ret += '</li>';
                }
                ret += '</ul>';
    ...
    setevents = function(){
        ...
        $this.find('li a').bind('click', function() {
            options.onclick(this, $(this).attr('data-type'),$(this).attr('data-file'), $(this).attr('data-ext'));
